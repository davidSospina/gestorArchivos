        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="alert alert-success" role="alert">
                    ...
                    <p class="mb-0">
                        ...
                        * Puedes editar (botón gris con un lapicero), o eliminar (botón rojo con un basurero) tus archivos.
                        Sí eliminas una carpeta estarás eliminando todo lo que hay dentro de ella. <br> <br>
                ...
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                <a class="btn btn-success m-3" href=<?php echo "nuevoArchivo.php?padre_id=1"; ?> role=button> 
                                <i class="fa fa-plus"></i>  Nuevo</a>   
                            </li>
                        </ul>
                        <a class="btn btn-primary btn m-3" href="listarSeccion.php?id=0" role="button"><i class="fa fa-sitemap"></i>  Visualizar por secciones</a>
                    </div>
                </nav>
                ...
                <table class="table table-hover mt-3">
                    ...
                    <?php
                        $query = "SELECT * FROM directorios WHERE tipo = 'Documento' OR tipo = 'Imagen' OR tipo = 'Video' OR tipo = 'Codigo' ORDER BY nombre";
                        ...
                        <tr>
                            ...
                            <td> <a href="<?php echo "uploads/". $row['archivo_URL'] ?>" target="_blank"> <?php echo $row['archivo_URL'] ?> </a> </td>
                            <td>
